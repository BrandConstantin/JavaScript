...
function empezar() {
    ...
    var izqBebe = Math.floor(Math.random() * 1700);
    bebe.style.left = izqBebe + "px";
    var topBebe = Math.floor(Math.random() * 700);
    ...
    //lo posiciono de forma aleatoria dentro del cuadro de juego
    var izqMosq = Math.floor(Math.random() * 1700);
    mosquito.style.left = izqMosq + "px";
    var topMosq = Math.floor(Math.random() * 700);
